...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(199, 37, 35, 35),
      body: screens[currentIndex],
      bottomNavigationBar: CurvedNavigationBar(
        buttonBackgroundColor: const Color.fromARGB(209, 115, 67, 236),
        height: 50,
        index: currentIndex,
        color: const Color.fromARGB(187, 28, 24, 26),
      ...
      //         ? SizedBox()
      //         : ListTile(
      //             selectedTileColor: Color.fromARGB(209, 115, 67, 236),
      //             // onTap: () {
